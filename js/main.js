...
(()=>{
    ...
    document.addEventListener("click", (event)=>{
        ...
        if(event.target.classList.contains('link-item')){
            //make sure event.target.hash has a value before override default behavior
            if(event.target.hash !==""){
                ...
                //if clicked link item is contained w/in navigation menu
                if(navMenu.classList.contains("open")){
                    ...
                    navItems.forEach((item) =>{
                        if(hash === item.hash){  
                            //activate new navigation menu linked item
...
(() =>{
    ...
    //set for width of all slide
    slides.forEach((slide) =>{
    slide.style.width = slideWidth + "px";
    })
    // section width of sliderContainer
